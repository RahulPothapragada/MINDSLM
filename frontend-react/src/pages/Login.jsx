      ...
      <div style={{ width: '100%', maxWidth: 360, animation: 'fadeUp 0.3s ease forwards' }}>
        ...
        >
          <svg width="16" height="16" viewBox="0 0 48 48">
            <path fill="#FFC107" d="M43.6 20H24v8h11.3C33.7 33.9 29.3 37 24 37c-7.2 0-13-5.8-13-13s5.8-13 13-13c3.1 0 5.9 1.1 8.1 2.9l5.7-5.7C34.5 5.1 29.5 3 24 3 12.4 3 3 12.4 3 24s9.4 21 21 21c10.5 0 20-7.6 20-21 0-1.3-.1-2.7-.4-4z"/>
        ...
        <p style={{ textAlign: 'center', fontSize: 13, color: '#636366', marginTop: 20 }}>
          No account?{' '}
          <Link to="/register" style={{ color: '#aeaeb2', fontWeight: 500 }}>Create one</Link>
        </p>
      </div>
    </div>
  )
